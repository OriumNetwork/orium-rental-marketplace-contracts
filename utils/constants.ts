...
export const PROPERTY_MANAGER = keccak256(encodePacked(['string'], ['PROPERTY_MANAGER']))
export const PROPERTY_TENANT = keccak256(encodePacked(['string'], ['PROPERTY_TENANT']))
